...
def scale_rv(normalised_rvs, period_in_days, m1, m2, inclination,group_velocity=0):
    ...
    return normalised_rvs * a1 * np.sin(np.radians(inclination)) * AU_in_km / day_in_seconds + group_velocity
...
def random_orbits(p_prior_type='LogNorm', p_max=365.25*20, e_prior_type='Uniform', \
    ...
    #Calculate a system system velocity
    
    return params
    
def binary_orbit_rv(params, jds, niter_anomaly=5, do_deriv=False,plot_orbit_no=0):
