...
plt.errorbar(np.array(masses)-150, Median_grads[0], yerr=Core_err, label='Core Fragmentation', color='b')
plt.errorbar(np.array(masses)-50, Median_grads[1], yerr=Delayed_core_err, label='Delayed Core Frag.', color='purple')
plt.errorbar(np.array(masses)+50, Median_grads[2], yerr=Capt_err, label='Dynamical Capture', color='r')
plt.errorbar(np.array(masses)+150, Median_grads[3], yerr=Other_err, label='Other', color='orange')
