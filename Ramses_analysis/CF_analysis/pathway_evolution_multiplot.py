...
grad_bins = np.concatenate((-1*np.logspace(2,-5,22)[1:], np.array([0, 1.e10])))#np.concatenate((-1*np.logspace(2,-6,28)[1:-2], np.array([0, 1.e10])))#np.concatenate((-1*np.logspace(3,-6,19)[1:-2], np.array([0, 1.e10]))) #np.concatenate((-1*np.logspace(5,-3,9), np.array([0, 1.e10])))
