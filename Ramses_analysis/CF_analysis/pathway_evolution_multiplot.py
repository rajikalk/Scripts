...
for grad_it in range(len(grad_pickles)):
    ...
    for Initial_mean_grad in mean_grads:
        ...
        popt, pcov = curve_fit(Gaussian, bin_centers, (grad_hist_core_mean_norm), [scale_guess, mean_guess, std_guess])
        ...
        popt, pcov = curve_fit(Gaussian, bin_centers, (grad_hist_core_delayed_mean_norm), [scale_guess, mean_guess, std_guess])
        x_fit = np.linspace(0, len(grad_hist_core))
        fit = Gaussian(x_fit, *popt)
        ...
        popt, pcov = curve_fit(Gaussian, bin_centers, (grad_hist_capt_mean_norm), [scale_guess, mean_guess, std_guess])
        x_fit = np.linspace(0, len(grad_hist_core))
        fit = Gaussian(x_fit, *popt)
        ...
        popt, pcov = curve_fit(Gaussian, bin_centers, (grad_hist_misc_mean_norm), [scale_guess, mean_guess, std_guess])
        x_fit = np.linspace(0, len(grad_hist_core))
        fit = Gaussian(x_fit, *popt)
