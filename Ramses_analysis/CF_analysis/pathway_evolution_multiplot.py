...
for grad_it in range(len(grad_pickles)):
    ...
    Std_grads_10000[0].append(np.std(np.log10(-1*np.array(Initial_gradients_10000[0]).T[0][core_inspiral_inds])))
    
    Mean_grads_10000[1].append(np.mean(np.log10(-1*np.array(Initial_gradients_10000[1]).T[0][delayed_core_inspiral_inds])))
    Median_grads_10000[1].append(np.median(np.log10(-1*np.array(Initial_gradients_10000[1]).T[0][delayed_core_inspiral_inds])))
    Std_grads_10000[1].append(np.std(np.log10(-1*np.array(Initial_gradients_10000[1]).T[0][delayed_core_inspiral_inds])))
    
    Mean_grads_10000[2].append(np.mean(np.log10(-1*np.array(Initial_gradients_10000[2]).T[0][capt_inspiral_inds])))
    Median_grads_10000[2].append(np.median(np.log10(-1*np.array(Initial_gradients_10000[2]).T[0][capt_inspiral_inds])))
    Std_grads_10000[2].append(np.std(np.log10(-1*np.array(Initial_gradients_10000[2]).T[0][capt_inspiral_inds])))
    
    Mean_grads_10000[3].append(np.mean(np.log10(-1*np.array(Initial_gradients_10000[3]).T[0][other_inspiral_inds])))
    Median_grads_10000[3].append(np.median(np.log10(-1*np.array(Initial_gradients_10000[3]).T[0][other_inspiral_inds])))
    Std_grads_10000[3].append(np.std(np.log10(-1*np.array(Initial_gradients_10000[3]).T[0][other_inspiral_inds])))
...
print("All: median:", median_val, ", mean", mean_val, "+/-", [upp_err, low_err])
...
upp_err = upp_val - median_val
low_err = median_val - low_val
print("Bound core frag:", median_val, ", mean", mean_val, "+/-", [upp_err, low_err])
...
upp_err = upp_val - median_val
low_err = median_val - low_val
print("Unbound core frag:", median_val, ", mean", mean_val, "+/-", [upp_err, low_err])
...
upp_err = upp_val - median_val
low_err = median_val - low_val
print("Dynamical cap:", median_val, ", mean", mean_val, "+/-", [upp_err, low_err])
...
upp_err = upp_val - median_val
low_err = median_val - low_val
print("All:", median_val, ", mean", mean_val, "+/-", [upp_err, low_err])
