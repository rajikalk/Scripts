                            ...
                            if np.mean(np.array(sub_sys)<superplot_dict['N_stars'][-1]) == 1:
                                if str(np.max(sub_sys)) in Sink_birth_all.keys():
                                    ...
                                    if Sink_birth_all[str(np.max(sub_sys))][0] == True and other_sys in flatten(eval(str(Sink_birth_all[str(np.max(sub_sys))][1]))):
                                        ...
                                        if Sink_birth_all[str(np.max(sub_sys))][1] in flatten(eval(Sink_birth_all[str(np.max(sub_sys))][2])):
                                            marker_color = 'm'
                                            marker_shape = '^'
                                        else:
                                            marker_color = 'r'
                                ...
                                if len(real_sinks) > 0:
                                    if str(np.max(real_sinks)) in Sink_birth_all.keys():
                                        ...
                                        if Sink_birth_all[str(np.max(real_sinks))][0] == True and other_sys_str in str(Sink_birth_all[str(np.max(real_sinks))][1]):
                                            ...
                                            if Sink_birth_all[str(np.max(real_sinks))][1] in flatten(eval(Sink_birth_all[str(np.max(real_sinks))][2])):
                                                marker_color = 'm'
                                                marker_shape = '^'
                                            else:
                                                marker_color = 'r'
