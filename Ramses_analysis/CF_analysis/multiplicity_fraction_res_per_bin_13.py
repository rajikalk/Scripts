...
#Open perseus pickle:
file = open("/groups/astro/rlk/rlk/Analysis_plots/Superplot_pickles_entire_sim/Perseus_data.pkl", "rb")
    ...
    for key in Orion_objs_cleaned.keys():
        ...
        if larger_seps > 0:
            if binaries == 0 and smaller_seps == 0:
                ...
                sys_sub_comps = sys_sub_comps + [larger_seps+1]
            else:
                import pdb
                pdb.set_trace()
        import pdb
        ...
        if N_comps == 1:
            ...
            if larger_seps == 5:
                N_comps_in_sys = N_comps_in_sys + [1, 1, 1, 1, 1, 1]
            elif binaries == 1 and larger_seps == 4:
