    ...
    for time_it in range(start_time_it, len(global_data['time'].T[0])):
        ...
        if rank == rit:
            ...
            if len(n_stars) > 1:
                ...
                vis_tobin_C0I = np.where((L_tot>=0.09)&(L_tot<=55.29)&(M_dot>=1.e-7))[0]
                ...
                N_vis_tobin_C0I.append(len(vis_tobin_C0I))
                ...
                pickle.dump((Times, SFE, Class_0, Class_0_I, N_total, N_vis_tobin, N_vis_tobin_C0, N_vis_tobin_C0I, N_vis_stars_UL, N_vis_stars_NUL),file)
                file.close()
...
if rank == 0:
    ...
    if len(pickle_files) > 0:
        ...
        for pick_file in pickle_files:
            ...
            Full_N_vis_tobin_C0I = Full_N_vis_tobin_C0I + N_vis_tobin_C0I
        ...
        N_vis_tobin_C0I = np.array(Full_N_vis_tobin_C0I)[sorted_inds]
...
plt.plot(SFE, N_vis_tobin_C0I, label='C0I')
plt.legend(loc='best')
plt.xlabel('SFE')
plt.ylabel('N stars')
plt.xlim([0, 0.05])
plt.savefig('Tobin.png')
