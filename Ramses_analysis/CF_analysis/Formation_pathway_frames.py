            ...
            if os.path.exists(pickle_file) == False:
                ...
                try:
                    if np.isnan(center_sink):
                        ...
                        import pdb
                        pdb.set_trace()
                        center_vel = yt.YTArray([loaded_sink_data['x'][center_sink]*units['length_unit'].in_units('au'), loaded_sink_data['y'][center_sink]*units['length_unit'].in_units('au'), loaded_sink_data['z'][center_sink]*units['length_unit'].in_units('au')])
