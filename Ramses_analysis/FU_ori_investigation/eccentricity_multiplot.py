...
x_right_lim = [None, 18000, None, 4100, None]
...
plt.clf()
fig, axs = plt.subplots(ncols=1, nrows=5, figsize=(single_col_width, 2.7*single_col_width), sharey=True)
...
for plot_sink in plot_sinks:
    ...
    axs.flatten()[sink_it].set_title(Cand_label, y=0.77)
    ...
    ax0.set_ylim([1, 5e3])
    ax0.set_ylabel("Semiminor Axis (AU)")
