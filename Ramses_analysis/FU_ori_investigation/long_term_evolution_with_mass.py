...
lns3 = ax0.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", alpha=0.25, lw=0.5, label="Candidate Mass")
lns4 = ax0.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", alpha=0.25, lw=0.5, label="Closest sink Mass")
lns5 = ax00.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
lns = lns1+lns2+lns3+lns4+lns5
labs = [l.get_label() for l in lns]
axs.flatten()[0].legend(lns, labs, loc='lower left')
ax0.set_ylabel('Mass (M$_\odot$)')
ax00.set_ylabel('Separation (au)')
...
ax1.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax1.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
ax10.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
ax1.set_ylabel('Mass (M$_\odot$)')
ax10.set_ylabel('Separation (au)')
ax10.spines['right'].set_position(('outward', 60))
#ax1.set_ylim([5,1000])
...
ax2.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax2.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
ax20.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
ax2.set_ylabel('Mass (M$_\odot$)')
ax20.set_ylabel('Separation (au)')
ax20.spines['right'].set_position(('outward', 60))
#ax2.set_ylim([5,1000])
...
ax3.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax3.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
ax30.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
ax3.set_ylabel('Mass (M$_\odot$)')
ax30.set_ylabel('Separation (au)')
ax30.spines['right'].set_position(('outward', 60))
#ax3.set_ylim([5,1000])
...
ax4.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax4.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
ax40.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="-", alpha=0.25, label="Separation")
ax4.set_ylabel('Mass (M$_\odot$)')
ax40.set_ylabel('Separation (au)')
ax40.spines['right'].set_position(('outward', 60))
#ax4.set_ylim([5,1000])
...
ax0 = axs.flatten()[0].twinx()
ax00 = axs.flatten()[0].twinx()
lns3 = ax0.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
lns4 = ax0.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
lns5 = ax00.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
lns = lns1+lns2+lns3+lns4+lns5
labs = [l.get_label() for l in lns]
axs.flatten()[0].legend(lns, labs, loc='lower left')
