...
axs.flatten()[0].yaxis.set_tick_params(which='both', direction='in')
axs.flatten()[0].xaxis.set_tick_params(which='both', direction='in', top=True)
axs.flatten()[0].tick_params(axis='both', which='minor')
ax0 = axs.flatten()[0].twinx()
ax00 = axs.flatten()[0].twinx()
lns3 = ax0.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
lns4 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", alpha=0.25, lw=1, label="Candidate Mass")
lns5 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", alpha=0.25, lw=1, label="Closest sink Mass")
lns = lns1+lns2+lns3+lns4+lns5
labs = [l.get_label() for l in lns]
axs.flatten()[0].legend(lns, labs, loc='lower left')
ax0.set_ylabel('Separation (au)')
ax00.set_ylabel('Mass (M$_\odot$)')
ax00.spines['right'].set_position(('outward', 50))
#ax0.set_ylim([5,1000])
ax0.yaxis.set_tick_params(which='both', direction='in')
...
axs.flatten()[1].yaxis.set_tick_params(which='both', direction='in')
axs.flatten()[1].xaxis.set_tick_params(which='both', direction='in', top=True)
axs.flatten()[1].tick_params(axis='both', which='minor')
ax1 = axs.flatten()[1].twinx()
ax10 = axs.flatten()[1].twinx()
ax10.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
ax10.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
ax1.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
ax10.set_ylabel('Mass (M$_\odot$)')
ax1.set_ylabel('Separation (au)')
ax10.spines['right'].set_position(('outward', 50))
#ax1.set_ylim([5,1000])
...
axs.flatten()[2].yaxis.set_tick_params(which='both', direction='in')
axs.flatten()[2].xaxis.set_tick_params(which='both', direction='in', top=True)
axs.flatten()[2].tick_params(axis='both', which='minor')
ax2 = axs.flatten()[2].twinx()
ax20 = axs.flatten()[2].twinx()
ax20.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
ax20.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
ax2.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
ax20.set_ylabel('Mass (M$_\odot$)')
ax2.set_ylabel('Separation (au)')
ax20.spines['right'].set_position(('outward', 50))
#ax2.set_ylim([5,1000])
...
axs.flatten()[3].yaxis.set_tick_params(which='both', direction='in')
axs.flatten()[3].xaxis.set_tick_params(which='both', direction='in', top=True)
axs.flatten()[3].tick_params(axis='both', which='minor')
ax3 = axs.flatten()[3].twinx()
ax30 = axs.flatten()[3].twinx()
ax30.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
ax30.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
ax3.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
ax30.set_ylabel('Mass (M$_\odot$)')
ax3.set_ylabel('Separation (au)')
ax30.spines['right'].set_position(('outward', 50))
#ax3.set_ylim([5,1000])
...
axs.flatten()[4].yaxis.set_tick_params(which='both', direction='in')
axs.flatten()[4].xaxis.set_tick_params(which='both', direction='in', top=True)
axs.flatten()[4].tick_params(axis='both', which='minor')
ax4 = axs.flatten()[4].twinx()
ax40 = axs.flatten()[4].twinx()
ax40.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
ax40.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
ax4.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="-", alpha=0.25, label="Separation")
ax40.set_ylabel('Mass (M$_\odot$)')
ax4.set_ylabel('Separation (au)')
ax40.spines['right'].set_position(('outward', 50))
#ax4.set_ylim([5,1000])
...
ax00 = axs.flatten()[0].twinx()
lns3 = ax0.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
lns4 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
lns5 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
lns = lns1+lns2+lns3+lns4+lns5
labs = [l.get_label() for l in lns]
axs.flatten()[0].legend(lns, labs, loc='lower left')
ax00.set_ylabel('Mass (M$_\odot$)')
...
ax00.spines['right'].set_position(('outward', 50))
#ax0.set_ylim([5,1000])
ax00.yaxis.set_tick_params(which='both', direction='in')
...
ax10.spines['right'].set_position(('outward', 50))
#ax1.set_ylim([5,1000])
ax10.yaxis.set_tick_params(which='both', direction='in')
...
ax20.spines['right'].set_position(('outward', 50))
#ax2.set_ylim([5,1000])
ax20.yaxis.set_tick_params(which='both', direction='in')
...
ax30.spines['right'].set_position(('outward', 50))
#ax3.set_ylim([5,1000])
ax30.yaxis.set_tick_params(which='both', direction='in')
...
ax40.spines['right'].set_position(('outward', 50))
#ax4.set_ylim([5,1000])
ax40.yaxis.set_tick_params(which='both', direction='in')
axs.flatten()[4].set_xlabel("Time since candidate formation (yr)")
#axs.flatten()[4].set_ylim([5.e-2, 2.5e1])
