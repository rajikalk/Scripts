...
ax00.spines['right'].set_position(('outward', 50))
#ax0.set_ylim([5,1000])
ax00.tick_params(axis='both', direction='in', top=True)
...
ax20.spines['right'].set_position(('outward', 50))
#ax2.set_ylim([5,1000])
ax20.tick_params(axis='both', direction='in', top=True)
...
ax30.spines['right'].set_position(('outward', 50))
#ax3.set_ylim([5,1000])
ax30.tick_params(axis='both', direction='in', top=True)
...
ax40.spines['right'].set_position(('outward', 50))
#ax4.set_ylim([5,1000])
ax40.tick_params(axis='both', direction='in', top=True)
axs.flatten()[4].set_xlabel("Time since candidate formation (yr)")
#axs.flatten()[4].set_ylim([5.e-2, 2.5e1])
