...
lns4 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", alpha=0.25, lw=0.5, label="Candidate Mass")
lns5 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", alpha=0.25, lw=0.5, label="Closest sink Mass")
lns = lns1+lns2+lns3+lns4+lns5
labs = [l.get_label() for l in lns]
axs.flatten()[0].legend(lns, labs, loc='lower left')
ax0.set_ylabel('Separation (au)')
ax00.set_ylabel('Mass (M$_\odot$)')
ax0.spines['right'].set_position(('outward', 40))
#ax0.set_ylim([5,1000])
...
ax10.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax10.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
...
ax1.spines['right'].set_position(('outward', 40))
#ax1.set_ylim([5,1000])
...
ax20.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax20.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
...
ax30.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax30.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
...
ax40.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
ax40.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
...
ax00 = axs.flatten()[0].twinx()
lns3 = ax0.semilogy(particle_data['time'], particle_data['separation'], color='g', ls="--", alpha=0.25, label="Separation")
lns4 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[0], color='k', ls="-", lw=0.5, alpha=0.25, label="Candidate Mass")
lns5 = ax00.plot(particle_data['time'], np.array(particle_data['mass']).T[1], color='k', ls=":", lw=0.5, alpha=0.25, label="Closest sink Mass")
lns = lns1+lns2+lns3+lns4+lns5
labs = [l.get_label() for l in lns]
axs.flatten()[0].legend(lns, labs, loc='lower left')
ax00.set_ylabel('Mass (M$_\odot$)')
