...
for sink_id in top_clean:
    ...
    if os.path.isfile(save_name) == False:
        ...
        lns4 = ax00.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[0], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
        lns5 = ax00.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[1], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
        lns.append(lns4)
        lns.append(lns5)
        ...
        ax10.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[0], color='k', ls="-", lw=1, alpha=0.25)
        ax10.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[1], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax20.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[0], color='k', ls="-", lw=1, alpha=0.25)
        ax20.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[1], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax30.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[0], color='k', ls="-", lw=1, alpha=0.25)
        ax30.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[1], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax40.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[0], color='k', ls="-", lw=1, alpha=0.25)
        ax40.plot(particle_data['time'][:end_it], np.array(particle_data['mass'][:end_it]).T[1], color='k', ls=":", lw=1, alpha=0.25)
