...
ax0.semilogy(particle_data['time'], particle_data['separation'], color='k', ls="--", alpha=0.5)
...
ax1.semilogy(particle_data['time'], particle_data['separation'], color='k', ls="--", alpha=0.5)
...
ax2.semilogy(particle_data['time'], particle_data['separation'], color='k', ls="--", alpha=0.5)
...
ax3.semilogy(particle_data['time'], particle_data['separation'], color='k', ls="--", alpha=0.5)
...
ax4.semilogy(particle_data['time'], particle_data['separation'], color='k', ls="--", alpha=0.5)
