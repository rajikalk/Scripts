...
top_clean = np.array([177, 292, 48, 51, 262, 195, 17, 10, 75, 159, 272, 275, 176, 118, 54, 45, 85, 103, 71, 101, 258, 150, 93, 221, 151, 154, 102, 168, 56, 309, 239, 109, 73, 72, 83, 141])
...
for sink_id in top_clean:
    ...
    if os.path.isfile(save_name) == False:
        ...
        ax0.axhline(y=16.6, color='k', ls='-.')
        ax0.axhline(y=200, color='k', ls='-.')
        lns.append(ln)
        color_it = 0
        ...
        lns4 = ax00.plot(particle_data['time'][:end_it], particle_data['mass'][:end_it], color='k', ls="-", lw=1, alpha=0.25, label="Candidate Mass")
        lns5 = ax00.plot(particle_data['time'][:end_it], particle_data['closest_mass'][:end_it], color='k', ls=":", lw=1, alpha=0.25, label="Closest sink Mass")
        lns.append(lns4)
        lns.append(lns5)
        ...
        ax00.set_ylim([0, np.max([np.max(particle_data['mass'][:end_it]), np.max(particle_data['closest_mass'][:end_it])])])
        ax0.set_ylim([5,1000])
        ...
        ax10.plot(particle_data['time'][:end_it], particle_data['mass'][:end_it], color='k', ls="-", lw=1, alpha=0.25)
        ax10.plot(particle_data['time'][:end_it], particle_data['closest_mass'][:end_it], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax10.set_ylim([0, np.max([np.max(particle_data['mass'][:end_it]), np.max(particle_data['closest_mass'][:end_it])])])
        ax1.set_ylim([5,1000])
        ...
        ax20.plot(particle_data['time'][:end_it], particle_data['mass'][:end_it], color='k', ls="-", lw=1, alpha=0.25)
        ax20.plot(particle_data['time'][:end_it], particle_data['closest_mass'][:end_it], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax20.set_ylim([0, np.max([np.max(particle_data['mass'][:end_it]), np.max(particle_data['closest_mass'][:end_it])])])
        ax2.set_ylim([5,1000])
        ...
        ax30.plot(particle_data['time'][:end_it], particle_data['mass'][:end_it], color='k', ls="-", lw=1, alpha=0.25)
        ax30.plot(particle_data['time'][:end_it], particle_data['closest_mass'][:end_it], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax30.set_ylim([0, np.max([np.max(particle_data['mass'][:end_it]), np.max(particle_data['closest_mass'][:end_it])])])
        ax3.set_ylim([5,1000])
        ...
        ax40.plot(particle_data['time'][:end_it], particle_data['mass'][:end_it], color='k', ls="-", lw=1, alpha=0.25)
        ax40.plot(particle_data['time'][:end_it], particle_data['closest_mass'][:end_it], color='k', ls=":", lw=1, alpha=0.25)
        ...
        ax40.set_ylim([0, np.max([np.max(particle_data['mass'][:end_it]), np.max(particle_data['closest_mass'][:end_it])])])
        ax4.set_ylim([5,1000])
