...
for sink_id in top_clean:
    ...
    if os.path.isfile(save_name) == False:
        ...
        ax00.set_ylim([0, np.max([np.max(particle_data['mass']), np.max(particle_data['closest_mass'])])])
        ax0.set_ylim([5,1000])
        ...
        ax10.set_ylim([0, np.max([np.max(particle_data['mass']), np.max(particle_data['closest_mass'])])])
        ax1.set_ylim([5,1000])
        ...
        ax20.set_ylim([0, np.max([np.max(particle_data['mass']), np.max(particle_data['closest_mass'])])])
        ax2.set_ylim([5,1000])
        ...
        ax30.set_ylim([0, np.max([np.max(particle_data['mass']), np.max(particle_data['closest_mass'])])])
        ax3.set_ylim([5,1000])
        ...
        ax40.set_ylim([0, np.max([np.max(particle_data['mass']), np.max(particle_data['closest_mass'])])])
        ax4.set_ylim([5,1000])
