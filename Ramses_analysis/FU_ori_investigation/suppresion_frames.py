...
for plot_time in plot_times:
    ...
    if os.path.isfile(part_info_pickle) == False:
        ...
        files = glob.glob('/home/100/rlk100/gdata/RAMSES/Zoom-in_CPH_sims/Sink_45/Level_19/Level_20/Event_'+str(event_it)+'/data/*/info*')
    ...
    if plot_it == n_frames-1:
        ...
        if event_it == 5:
            cbar.set_label(r"Density (g$\,$cm$^{-3}$)", labelpad=-8, rotation=270, size=font_size, y=8.e-14)
        else:
