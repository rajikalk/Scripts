...
for tag in particle_data['tag']:
    ...
    axs.flatten()[0].semilogy(particle_data['time'][tag_it], particle_data['mdot'][tag_it])
    ...
    axs.flatten()[1].semilogy(particle_data['time'][tag_it], particle_data['mdot'][tag_it])
    ...
    axs.flatten()[2].semilogy(particle_data['time'][tag_it], particle_data['mdot'][tag_it])
    ...
    axs.flatten()[3].semilogy(particle_data['time'][tag_it], particle_data['mdot'][tag_it])
    ...
    axs.flatten()[4].semilogy(particle_data['time'][tag_it], particle_data['mdot'][tag_it])
