...
for pf in ts:
	...
	#Find relative position of particles to com
	...
	#find projection of particle velocity in radial direction
	ang1 = angle(pv1, rel1)
	ang2 = angle(pv2, rel2)
	ps1 = ps1*math.cos(ang1)
	ps2 = ps2*math.cos(ang2)
	...
	ang1 = angle(bv1, rel1)
	ang2 = angle(bv2, rel2)
	bs1 = bs1*math.cos(ang1)
	bs2 = bs2*math.cos(ang2)

	#find radial momentum of gas relative to particle
	rL1 = (bs1 - ps1)*gm1
	rL2 = (bs2 - ps2)*gm2
	rL_1.append(rL1)
	rL_2.append(rL2)
	...
	plt.savefig('relative_radial_momentum.png')
