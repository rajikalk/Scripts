        ...
        if os.path.isfile('job.sh') == False:
            ...
            for line in script_lines:
                if line == '#PBS -N ':
                    ...
                    write_line = 'mpirun -np $PBS_NCPUS ~/Scripts/Ramses_analysis/movie_script.py '+zoom_dir+' ./ -sink '+Sink_id+' -sf 0 -dt 50 -cmin 1.e-18 -cmax 1.e-15 -at True -pvl True -ax '+dir.lower()+' -al 1000 -tf 12 -stdv 5 -thickness 2000 -use_gas False -ic 1 -update_alim True -frames_only False -apm True 1>'+job_name+'.out01 2>&1'
                else:
                    write_line = line
