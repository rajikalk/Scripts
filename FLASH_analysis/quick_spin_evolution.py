...
plt.semilogy(S_2_time/31557600.0, S_2_total_spin, 'b-', label='Single Low Initial Cloud Rotation')
plt.semilogy(S_25_time/31557600.0, S_25_total_spin, 'r-', label='Single High Initial Cloud Rotation')
plt.semilogy(B_2_time_1/31557600.0, B_2_total_spin_1, 'b--', label='Primary Low', alpha=0.5)
plt.semilogy(B_2_time_2/31557600.0, B_2_total_spin_2, 'b-.', label='Secondary Low', alpha=0.5)
plt.semilogy(B_25_time_1/31557600.0, B_25_total_spin_1, 'r--', label='Primary High', alpha=0.5)
plt.semilogy(B_25_time_2/31557600.0, B_25_total_spin_2, 'r-.', label='Secondary High', alpha=0.5)
