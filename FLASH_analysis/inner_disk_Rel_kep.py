...
for spin_lab in Spin_labels:
    for mach_lab in Mach_labels:
        ...
        if os.path.exists(pickle_file):
            ...
            axs.flatten()[plot_it].plot(T_smoothed, Rel_kep_smoothed, label='10au', linestyle=line_styles[Spin_labels.index(spin_lab)], color='b', alpha=0.75, linewidth=1)
        else:
        ...
        if os.path.exists(pickle_file):
            ...
            axs.flatten()[plot_it].plot(T_smoothed, Rel_kep_smoothed, label='5au', linestyle=line_styles[Spin_labels.index(spin_lab)], color='o', alpha=0.75, linewidth=1)
        else:
            print("Couldn't open", pickle_file)
