...
for frame_it in range(10025):
    ...
    if rank == rit:
        ...
        if os.path.exists(savename) == False:
            plt.clf()
            fig, axs = plt.subplots(ncols=2, nrows=1, figsize=(single_col_width, two_col_width), sharex=True, sharey=True)
            ...
            pickle_file = '/home/kuruwira/fast/Movie_frames/Density/'+append_dir+'movie_frame_'+("%06d" % frame_it)+'.pkl'
