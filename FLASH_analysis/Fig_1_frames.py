...
for spin_val in spin_values:
    for mach_val in mach_values:
        ...
        if spin_val == '0.20':
            ...
            title_text = axs.flatten()[plot_it].text((np.mean(xlim)), (ylim[1]-0.04*(ylim[1]-ylim[0])), mach_label, va="center", ha="center", color='w', fontsize=(font_size), bbox=dict(facecolor='none', edgecolor='white', boxstyle='round'))
