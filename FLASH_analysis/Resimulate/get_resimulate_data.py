...
print("xmin = " + str(xmin.in_units('cm')))
print("xmax = " + str(xmax.in_units('cm')))
print("ymin = " + str(ymin.in_units('cm')))
print("ymax = " + str(ymax.in_units('cm')))
print("zmin = " + str(zmin.in_units('cm')))
print("zmax = " + str(zmax.in_units('cm')))
