...
plt.clf()
fig, axs = plt.subplots(ncols=4, nrows=1, figsize=(two_col_width, 2), sharex=True, sharey=True)
...
cbar.set_label(r"Density (g$\,$cm$^{-3}$)", rotation=270, labelpad=10, size=font_size)

plt.savefig("Decra.pdf", format='pdf', bbox_inches='tight', dpi=300, pad_inches=0.02)
