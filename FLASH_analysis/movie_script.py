...
for pickle_file in pickle_files:
    ...
    if rank == rit:
        ...
        mym.my_own_quiver_function(ax, X_vel, Y_vel, velx.value, vely.value, plot_velocity_legend=True, limits=[xlim, ylim], standard_vel=yt.YTQuantity(5,'km/s').value, Z_val=None)
