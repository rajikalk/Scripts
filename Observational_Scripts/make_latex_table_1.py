...
with open('Table_1.csv', 'rU') as f:
    ...
    for row in reader:
        if header != 0:
            if float(row[9]) > 1000:
                line = row[0] + '&' + row[1] + '&' + row[2] + '&' + row[3] + '&' + row[4] + '&' + row[5] + '&' + row[6] + '&' + row[7] + '&' + str((np.round(float(row[8])*100.))/100.) + '&' + '$>10^3$' + '(' + row[10] + ')\\'
            else:
                line = row[0] + '&' + row[1] + '&' + row[2] + '&' + row[3] + '&' + row[4] + '&' + row[5] + '&' + row[6] + '&' + row[7] + '&' + str((np.round(float(row[8])*100.))/100.) + '&' + str((np.round(float(row[9])*100))/100.) + '(' + row[10] + ')\\'
