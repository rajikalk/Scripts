...
reduced_dir = '/Users/reggie/Documents/Observational_Data/RV_standards/PyWiFeS/'
...
if args.template_dir == None:
    templates_dir = '/Users/reggie/Documents/Scripts/tools/templates/'
else:
    templates_dir = args.template_dir
abs_temps = glob.glob('/Users/reggie/Documents/Scripts/tools/absorption_spec_F.fits')
sky_temp = glob.glob('/Users/reggie/Documents/Scripts/tools/wifes_sky.fits')
...
header = 0
with open('/Users/reggie/Documents/Observational_Data/RV_standards/RV_standard_clean.csv', 'rU') as f:
    reader = csv.reader(f)
    for row in reader:
        if header != 0:
...
f = open('/Users/reggie/Documents/Observational_Data/RV_standards/RV_standard_testing.csv', 'w')
f.write('Name,RV(km/s),Spectral Type,RA,DEC,file,SNR,Retrieved RV,RV_sig,Delta_RV,template\n')

if args.make_paper_plot == 'False':
    images = glob.glob('/Users/reggie/Documents/Observational_Data/RV_standards/Images/*/*fits*')
    for image in images:
        ...
        if obj_name in RV_standard_name:
            ...
            if os.path.isfile(full_file_path):
                ...
                template_name = '/Users/reggie/Documents/Scripts/tools/templates/' + obj_name + '_' + file.split('.p08')[0]+'.fits'
