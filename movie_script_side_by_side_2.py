...
start_frame = 43
source_directory = ["/Users/rajikak/Output/SingleStarOutFlow_lref_8/", "/Users/rajikak/Output/CircumbinaryOutFlow_0.25_lref_8/"]
...
for file in range(len(its)):
    ...
    while it < max_file[file]:
        if it not in its[file]:
            os.remove(source_directory[file] + "WIND_" + type[file] + "_" + axis[file] + "_" + ("%06d" % it))
        it = it + 1
