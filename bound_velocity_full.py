...
init_pf = load("/disks/ceres/makemake/acomp/jstaff/rajika/smallbox/rotation/run1.e-6lessetot_Gcorr_0.75k/hot3/DD0000/CE0000")
f = open('bound_velocity.csv','r+')
f.write("time, bound, unbound\n")
...
for pf in ts:
    ...
    TotalMass = (reg.quantities["TotalQuantity"]("TotalMassMsun")[0]*Msun) - mass_tot
    ...
    f.write(str(time_val) + "," + str(bound_percent) + "," + str(unbound_percent) + "\n" )
...
plt.savefig("velocity_full_unbound.png")
'''
